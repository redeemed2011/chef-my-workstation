...
#-----------------------------------------------------------------------------------------------------------------------
# NTP Settings
default['ntp']['servers'] = %w(time.google.com)
# default['ntp']['sync_clock'] = true
# At the time of this writing Ubuntu 16.04+ Desktop did not have apparmor enabled by default.
...
default['openssh']['server'].tap do |server|
  ...
  # server['listen_address'] = %w(0.0.0.0 ::)
